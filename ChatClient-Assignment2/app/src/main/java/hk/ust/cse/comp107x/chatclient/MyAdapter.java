...
public class MyAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        messageVieww =inflater.inflate(R.layout.mymessage,parent,false);
        ...
        if (messages.get(position).fromMe()) {
           ...
           TextView timeView=(TextView) messageVieww.findViewById(R.id.mytimeTextView);
            timeView.setText(messages.get(position).getTime());
            TextView msgView=(TextView) messageVieww.findViewById(R.id.mymessageTextView);
            msgView.setText(messages.get(position).getMessage());
            return messageVieww;
            //TODO
